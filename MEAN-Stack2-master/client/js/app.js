var app = angular.module('nibs', ['ionic','openfb','naif.base64','nibs.myaccount','nibs.config','nibs.profile', 'nibs.auth', 'nibs.product', 'nibs.store-locator', 'nibs.gallery', 'nibs.settings', 'nibs.case', 'nibs.fileupload','nibs.claim'])
